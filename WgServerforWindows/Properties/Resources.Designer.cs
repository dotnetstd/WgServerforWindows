...
namespace WgServerforWindows.Properties {
    ...
    public class Resources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Enable NAT on application startup.
        /// </summary>
        public static string EnableNatOnAppStart {
            get {
                return ResourceManager.GetString("EnableNatOnAppStart", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to When enabled, WS4W will attempt to enable NAT automatically on startup, only if the server configuration and tunnel service are already configured, and Internet Connection Sharing is not enabled..
        /// </summary>
        public static string EnableNatOnAppStartDescription {
            get {
                return ResourceManager.GetString("EnableNatOnAppStartDescription", resourceCulture);
            }
        }
        ...
        public static string TemporaryProfileDetected {
            get {
                return ResourceManager.GetString("TemporaryProfileDetected", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to WS4W has detected that you may be running with a temporary Windows profile (e.g., C:\Users\TEMP). This can happen if your normal profile is unavailable or corrupted. Any configurations saved in this session may be lost when the temporary profile is removed. To avoid losing your settings, consider switching to a permanent user profile before proceeding..
        /// </summary>
        public static string TemporaryProfileDetectedText {
            get {
                return ResourceManager.GetString("TemporaryProfileDetectedText", resourceCulture);
            }
        }
